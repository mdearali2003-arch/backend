...
exports.createProductHandler = (0, catchAsync_1.default)(async (req, res) => {
    const product = await service.createProduct(req.body);
    res.status(201).json({ success: true, data: product });
});
exports.getProductsHandler = (0, catchAsync_1.default)(async (req, res) => {
    const { docs, total } = await service.getProducts({}, 50, 0);
    res.json({ success: true, total, data: docs });
});
exports.getProductHandler = (0, catchAsync_1.default)(async (req, res) => {
