...
const controller = __importStar(require("./video.controller"));
const validateRequest_1 = require("../../middlewares/validateRequest");
const video_validation_1 = require("./video.validation");
const router = (0, express_1.Router)();
router.post("/", (0, validateRequest_1.validateRequest)(video_validation_1.createVideoSchema), controller.createVideo);
